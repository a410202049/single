...
/* contact.html.twig */
class __TwigTemplate_0d9c9d645e7c5855fee48942ef3a52ca27b087f106d965cedfa9e5586764bd1c extends Twig_Template
{
...
\t\t\t";
        // line 14
        $context["contact"] = $this->getAttribute(get_block("30"), 0, array(), "array");
        // line 15
        echo "\t\t\t\t";
...
\t\t<h5 class=\"pull-left\">";
        ...
        echo "</h5>
\t\t<h5 class=\"pull-right\">&copy; Copyright 2015 Eptonic. All Rights Reserved.</h5>
\t</div>
</footer>
";
    }
...
/* 							<a href="{{item.url}}" target="{{item.target}}" title="{{item.title}}"><img src="{{item.image_url}}" alt=""></a>*/
/* 						</div>*/
/* 				    {% endif %}*/
/* 				{% endfor %}*/
/* 		</div>*/
