...
/* social.html.twig */
class __TwigTemplate_329386c6d5c35ba969a2f7b079c911c20cc8d3c5534cc95bfe135669cfea29db extends Twig_Template
{
...
\t\t";
        // line 7
        $context["curtain"] = $this->getAttribute(get_block("41"), 0, array(), "array");
        echo "\t
\t\t<img src=\"";
        // line 8
...
\t\t\t\t<h2 style=\"font-family: fantasy;\">";
        // line 11
        echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute((isset($context["curtain"]) ? $context["curtain"] : null), "title", array())), "html", null, true);
        echo "</h2>
\t\t\t\t<h2>";
        // line 12
...
\t\t";
        // line 17
        $context["social"] = $this->getAttribute(get_block("41"), 0, array(), "array");
        // line 18
        echo "\t\t\t";
...
/* 	<div class="curtain">*/
/* 		{% set curtain = get_block("41")[0] %}	*/
/* 		<img src="{{curtain.image_url}}" alt="">*/
/* 		<div class="curtain-content text-white row-md">*/
/* 			<article>*/
/* 				<h2 style="font-family: fantasy;">{{curtain.title|upper}}</h2>*/
/* 				<h2>{{curtain.description}}</h2>*/
/* 			</article>	*/
/* 		</div>*/
/* 	</div>*/
/* 	<div class="container-fluid no-pd">*/
/* 		{% set social = get_block("41")[0] %}*/
