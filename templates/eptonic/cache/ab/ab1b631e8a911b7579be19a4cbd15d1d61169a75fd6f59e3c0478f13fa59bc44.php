...
/* emn.html.twig */
class __TwigTemplate_212e822e9b46e2bb8b6ecc960e8d84325b3ac8b515ba52b91b096403506089b1 extends Twig_Template
{
...
\t\t";
        // line 7
        $context["curtain"] = $this->getAttribute(get_block("43"), 0, array(), "array");
        echo "\t
\t\t<img src=\"";
        // line 8
...
/* 	<div class="curtain">*/
/* 		{% set curtain = get_block("43")[0] %}	*/
/* 		<img src="{{curtain.image_url}}" alt="">*/
/* 		<div class="curtain-content text-white row-md">*/
/* 			<article>*/
/* 				<h2>{{curtain.title}}</h2>*/
/* 				<h4>{{curtain.description}}</h4>*/
/* 				<a href="{{curtain.url}}" class="btn button" target="{{curtain.target}}">Sign Up Now</a>*/
/* 			</article>	*/
/* 		</div>*/
/* 	</div>*/
/* 	<div class="container-fluid no-pd">*/
